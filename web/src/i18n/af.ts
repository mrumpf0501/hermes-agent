...
export const af: Translations = {
  ...
  profiles: {
    ...
    deleted: "Geskrap",
    renamed: "Hernoem",
    editSkills: "Manage skills",
    skillsSection: "Skills",
    installedSkills: "Installed",
    noInstalledSkills: "No skills installed yet.",
    addFromHub: "Install from Skills Hub",
    hubIdentifierPlaceholder: "e.g. official/productivity/sorger-mittagessen",
    installSkill: "Install",
    copyFromProfile: "Copy from another profile",
    sourceProfile: "Source profile",
    skillToCopy: "Skill",
    copySkill: "Copy skill",
    skillInstalled: "Skill installed",
    skillCopied: "Skill copied",

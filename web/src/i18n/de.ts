...
export const de: Translations = {
  ...
  profiles: {
    ...
    deleted: "Gelöscht",
    renamed: "Umbenannt",
    editSkills: "Skills verwalten",
    skillsSection: "Skills",
    installedSkills: "Installiert",
    noInstalledSkills: "Noch keine Skills installiert.",
    addFromHub: "Aus Skills Hub installieren",
    hubIdentifierPlaceholder: "z. B. official/productivity/sorger-mittagessen",
    installSkill: "Installieren",
    copyFromProfile: "Von anderem Profil kopieren",
    sourceProfile: "Quellprofil",
    skillToCopy: "Skill",
    copySkill: "Skill kopieren",
    skillInstalled: "Skill installiert",
    skillCopied: "Skill kopiert",
